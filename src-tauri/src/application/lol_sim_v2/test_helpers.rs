...
pub(super) fn test_champion(
    ...
    ChampionRuntime {
        ...
        base_lethality: 0.0,
        bonus_lethality: 0.0,
        base_armor_pen_pct: 0.0,
        bonus_armor_pen_pct: 0.0,
        base_magic_pen_flat: 0.0,
        bonus_magic_pen_flat: 0.0,
        base_magic_pen_pct: 0.0,
        bonus_magic_pen_pct: 0.0,
        base_life_steal: 0.0,
        ...
        items: Vec::new(),
        inventory: Vec::new(),
        item_image_urls: Vec::new(),
        starter_item_name: String::new(),
        gameplay_score: 70.0,
        iq_score: 70.0,
